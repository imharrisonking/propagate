        ...
        "
			...
			>
				...
				>
					...
					>
						<path
							d="M37.9813 15.055L31.6688 16.4106L10.3313 20.9954L2.98125 22.5753C1.82569 22.8232 0.999393 23.855 1 25.0494V38.4722C1 39.8683 2.11929 41 3.5 41H38.5C39.8807 41 41 39.8683 41 38.4722V17.526C40.9994 16.7639 40.6588 16.0426 40.073 15.5631C39.4871 15.0836 38.7186 14.8969 37.9813 15.055Z"
							stroke="#C4CCD8"
						></path>
						<path
							d="M29.5899 1H12.5776C11.154 1 10 2.11929 10 3.5V28.5C10 29.8807 11.154 31 12.5776 31H29.4224C30.846 31 32 29.8807 32 28.5V3.5C32 2.11929 30.846 1 29.5899 1Z"
							stroke="#C4CCD8"
						></path>
					</svg>
				</div>
