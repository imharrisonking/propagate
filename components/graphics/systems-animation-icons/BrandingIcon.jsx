        ...
        "
			...
			>
				...
				>
					...
					>
						<path
							d="M14.909 6.93444C15.2533 5.31488 16.877 4 18.5328 4H38.5198C40.1756 4 41.2403 5.31488 40.8961 6.93444L34.7087 36.0437C34.4792 37.1234 33.3967 38 32.2929 38H8.32812L14.909 6.93444Z"
							stroke="#C4CCD8"
						></path>
						<path
							d="M1.10372 22.9344C0.75947 21.3149 1.82424 20 3.47998 20H23.467C25.1228 20 26.7465 21.3149 27.0908 22.9344L29.8772 36.0437C30.1067 37.1234 31.1892 38 32.2931 38H6.306C5.20217 38 4.11968 37.1234 3.89018 36.0437L1.10372 22.9344Z"
							stroke="#C4CCD8"
						></path>
					</svg>
				</div>
				...
				>
					...
					>
						<path
							...
							fill="url(#product-icon-identity-Sticky-a)"
						></path>
						<path
						...
						<path
							...
							fill="url(#product-icon-identity-Sticky-b)"
						></path>
						<defs>
							<linearGradient
								id="product-icon-identity-Sticky-a"
								x1="23.65"
								y1="2.99"
								x2="23.65"
								y2="37"
							...
							<linearGradient
								id="product-icon-identity-Sticky-b"
								x1="19.31"
								y1="19"
								x2="19.31"
								y2="37"
